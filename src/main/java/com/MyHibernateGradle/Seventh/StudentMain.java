...
public class StudentMain {
	...
	public static void main(String[] args) {
		...
		add1.setAddLine("house no - 1231, lane 1");
		add2.setAddLine("house no - 1232, lane 2");
		add3.setAddLine("house no - 1233, lane 3");
		add4.setAddLine("house no - 1234, lane 4");
		add5.setAddLine("house no - 1235, lane 5");
		add6.setAddLine("house no - 1236, lane 6");
		add7.setAddLine("house no - 1237, lane 7");
		add8.setAddLine("house no - 1238, lane 8");
